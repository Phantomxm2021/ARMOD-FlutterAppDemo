...
class RecommandCard extends StatelessWidget {
  final RecommandARExperienceProject recommandItem;
  final ValueChanged<RecommandARExperienceProject>? onSelected;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () {
          AppData.seleted_showcase_uid = recommandItem.project_id!;
